...
struct _ClutterActorClass
{
  ...
  /* This is called when an actor or its children are modified.
   * If it was a child that has been modified, the actor is supplied,
   * otherwise child==NULL.If it returns FALSE, traversal up the tree
   * of actors will stop */
  gboolean (* notify_modified)       (ClutterActor          *actor,
                                      ClutterActor          *child);
...
void                  clutter_actor_queue_redraw_damage       (ClutterActor          *self);
...
void clutter_actor_apply_relative_transform_to_point (ClutterActor  *self,
                                                      ...
                                                      ClutterVertex *point,
                                                      ClutterVertex *vertex);
void clutter_actor_set_visibility_detect             (ClutterActor *self,
                                                      gboolean use);
